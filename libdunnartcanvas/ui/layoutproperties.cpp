      ...
      m_mode_signal_mapper(NULL)
{
    ...
    rubberBandRoutingCheckBox->setVisible(false);
    this->pageBoundaryCheckBox->setVisible(false);
    flowOptionsLabel->setVisible(false);
    flowDirectionDial->setVisible(false);
    flowSeparationSlider->setVisible(false);
