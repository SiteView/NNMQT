...
////    QAction* devicePropertyAction = menu.addAction(tr("Éè±¸ÊôÐÔ"));
...
////    if(action == devicePropertyAction)
////    {
////        DevicePortInformation *devicePort = new DevicePortInformation;
////        devicePort->show();
////    }
...
QString ShapeObj::getDevType(void) const
{
//    return m_devType;
    return "temp";
}
...
void ShapeObj::setDevType(const QString &devType)
{
//    m_devType = devType;
//    update();
}
