...
#include "libdunnartcanvas/ui/interfaceinfo.h"
...
class Connector : public CanvasItem
{
    ...
    public:
        ...
        void setFlowThreshold(int iSpeed, int iIndex);

        void setLeftNodeType(QString strType);
        void setEdgeInfo(EDGE edge);
    ...
    signals:
        void modifyFlow(int iSpeed, int iIndex);
        void stopMonitorThread();

    public slots:
        void swapDirection(void);
        void RecivePortFlow(int iSpeed);
    ...
    protected:
        ...
        int m_iThresholdSpeed;
        int m_iFlowDialogUnitIndex;
        QColor m_iLineColor;

        InterfaceInfo *m_pInterfaceInfo;
        monitor *devMonitor;
        QString m_strLeftNodeType;
        EDGE m_edge;
