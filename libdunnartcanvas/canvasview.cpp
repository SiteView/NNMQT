        ...
        QMenu& menu)
{
    ...
    QAction *zoomToFitDiagram =
            menu.addAction(tr("Zoom to fit Diagram"));
    QAction *flowThreshold =
            menu.addAction(tr("Flow threshold setting"));
...
//    //---qicheng.ai test
//    QAction* aqcTestAction = menu.addAction(
//            tr("AQC Test"));
    //---end
...
//    }
    ...
    QAction *action = menu.exec(event->globalPos(), zoomToFitDiagram);
    ...
    else if (action == flowThreshold)
    {
        if (NULL == m_pFlowThreshold)
        {
            m_pFlowThreshold = new InterfaceInfo();
            m_pFlowThreshold->setWindowTitle(tr("Default Flow Threshold"));
            connect(m_pFlowThreshold, SIGNAL(flowThreChanged(int,int)), this, SLOT(flowThreChanged(int,int)));
        }
        m_pFlowThreshold->show();
//        QList<CanvasItem *> canvas_items = canvas->items();
//        for (int i = 0; i < canvas_items.size(); ++i)
//        {
//            Connector *conn = dynamic_cast<Connector *>(canvas_items.at(i));
...
//    }
//    else if(action == aqcTestAction)
//    {
//        TextShape *shape1 = new TextShape();
//        shape1->setLabel("asdfasdf");
//        shape1->setPosAndSize(QPointF(0,0), QSizeF(20,20));
//        canvas()->addItem(shape1);
//        TextShape *shape2 = new TextShape();
//        shape2->setPosAndSize(QPointF(20,40), QSizeF(20,20));
//        canvas()->addItem(shape2);
//        TextShape *shape3 = new TextShape();
//        shape3->setPosAndSize(QPointF(40,60), QSizeF(20,20));
//        canvas()->addItem(shape3);
//        TextShape *shape4 = new TextShape();
//        shape4->setPosAndSize(QPointF(60,80), QSizeF(20,20));
//        canvas()->addItem(shape4);
//        TextShape *shape5 = new TextShape();
//        shape5->setPosAndSize(QPointF(80,100), QSizeF(20,20));
//        canvas()->addItem(shape5);
