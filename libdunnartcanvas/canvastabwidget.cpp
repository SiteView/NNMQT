...
//    m_action_hidePc = new QAction(QIcon(":/resources/node_images/PC_Gray.png"),
//                                 tr("Hide PC"), this);
//    connect(m_action_hidePc,SIGNAL(triggered(bool)),this,SLOT(showPC(bool)));
//    m_action_autoLayout = new QAction(QIcon(":/resources/images/layout.png"),
...
//    m_undo_group->addStack(canvas->undoStack());
    ...
    insertTab(INT_MAX, canvasview, QString(tr("Topology diagram %1")).arg(count() + 1));
...
//    edit_toolbar->addSeparator();
//    edit_toolbar->addAction(m_action_hidePc);
//    edit_toolbar->addAction(m_action_autoLayout);
