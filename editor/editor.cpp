...
int main(int argc, char *argv[])
{
    ...
    if("CN" == lang)
    {
        translator.load(":/resources/language/NNM_CN.qm");
        qtTranslator.load(":/resources/language/qt_zh_CN.qm");
        app.installTranslator(&qtTranslator);
    }else if("EN"==lang)
    {
        translator.load(":/resources/language/NNM_EN.qm");
    }
    app.installTranslator(&translator);

    QApplication::setStyle(new QCleanlooksStyle);
    QFile file(":/resources/qss/candy.qss");
    ...
    QIcon appIcon(":/resources/images/logo.ico");
